          ...
          console.log(shopEquiNo);
              ...
              <div class="toolTitle">
                  ...
                  <div class="col-6">
                      ...
                      <div class="productTitle">
                          <h3 class="clothName2">${shopEquiNo[1].clothName}</h3>
                  ...
                  <div class="col-6">
                      ...
                      <div class="productTitle">
                          <h3 class="clothName3">${shopEquiNo[2].clothName}</h3>
                  ...
                  <div class="col-6">
                      ...
                      <div  class="productTitle">
                          <h3 class="clothName4">${shopEquiNo[3].clothName}</h3>
                          <div class="productBtn4">
                              <button id="shopSpanLogin" >${shopEquiNo[3].clothPrice}</button>
                              <span class="popularityAdd4" style="visibility:hidden">${shopEquiNo[3].popularAmount}</span>    
                              <span class="clothNo4" style="visibility:hidden">${shopEquiNo[3].clothNo}</span>
                              <span class="clothClass4" style="visibility:hidden">${shopEquiNo[3].clothClass}</span>
                          </div>
                      </div>  
                  </div>
              `)
           ...
           if( xhr.status == 200 ){
            ...
            console.log(shopEqui[1][0].popularity);
                ...
                <div class="toolTitle">
                    ...
                    <div class="col-6">
                        <div class="productPic">
                                <img id="shopPic2" src="${shopEqui[0][4].clothimg}" width="128" onclick="loadImage02()"/>
                        </div>
                        <div class="productTitle">
                            <h3 class="clothName2">${shopEqui[0][4].clothName}</h3>
                            <div class="productBtn2">
                                <button id="shopSpanLogin" >${shopEqui[0][4].clothPrice}</button>
                                <span class="popularityAdd2" style="visibility:hidden">${shopEqui[0][4].popularAmount}</span>    
                                <span class="clothNo2" style="visibility:hidden">${shopEqui[0][4].clothNo}</span>
                                <span class="clothClass2" style="visibility:hidden">${shopEqui[0][4].clothClass}</span>
                            </div>
                        </div>  
                    </div>    
                    <div class="col-6">
